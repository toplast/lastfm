...
export interface IGetLovedTracksParams {
...
export interface IGetPersonalTagsParams {
...
export interface IGetRecentTracksParams {
...
export interface IGetTopAlbumsParams {
...
export interface IGetTopArtistsParams {
...
export interface IGetTopTagsParams {
  /** The user name */
  user: string;
...
export interface IGetTopTracksParams {
...
export interface IGetWeeklyAlbumChartParams {
...
export interface IGetWeeklyArtistChartParams {
  /** The last.fm username to fetch the charts of. */
  user: string;
...
export interface IGetWeeklyChartListParams {
  /** The last.fm username to fetch the charts list for. */
  user: string;
}

export interface IGetWeeklyTrackChartParams {
  /** The last.fm username to fetch the charts of. */
  user: string;
  /** The date at which the chart should start from. See User.getWeeklyChartList for more. */
  from?: string;
